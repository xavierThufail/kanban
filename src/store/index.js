...
export default new Vuex.Store({
  ...
  actions: {
    getBoards ({ commit }) {
      commit('SET_LOADING')
      axios.get('https://my-json-server.typicode.com/xavierThufail/kanban/boards')
        .then(({ data }) => {
    ...
    addBoard ({ commit, state }, title) {
      ...
      axios({
        method: 'post',
        url: 'https://my-json-server.typicode.com/xavierThufail/kanban/boards',
        body,
        headers: {
    ...
    deleteBoard ({ commit, state }, id) {
      ...
      axios({
        ...
        // url: `https://my-json-server.typicode.com/xavierThufail/kanban/boards/${id}`,
        url: 'https://my-json-server.typicode.com/xavierThufail/kanban/boards/1'
      })
        .then(({ data }) => {
    ...
    patchBoard ({ commit, state }, board) {
      ...
      axios({
        method: 'put',
        // karena ini fake database, jadi idnya cuma bisa 1
        // url: `https://my-json-server.typicode.com/xavierThufail/kanban/boards/${board.id}`,
        url: 'https://my-json-server.typicode.com/xavierThufail/kanban/boards/1',
